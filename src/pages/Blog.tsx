...
const Blog = () => {
  ...
  const blogListJsonLd = {
    ...
    description:
      "Expert travel guides, trekking tips, festival guides & insider knowledge for Nagaland and Northeast India.",
    ...
    blogPost: blogPosts.map((post) => ({
      ...
      url: `https://naga-bivouc.lovable.app/blog/${post.slug}`,
      ...
      <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-4 tracking-tight">
            Nagaland & Northeast India Guides
          </h1>
          <p className="text-lg text-white/80 max-w-2xl mx-auto">
            Insider tips, trekking guides, festival info & cultural stories from
            local travel experts based in Nagaland.
          </p>
        </motion.div>
      </section>
