            ...
            <div className="grid md:grid-cols-2 gap-12 items-start">
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-xl border bg-background/60">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">nagabivouac@gmail.com</p>
                    </div>
                  </div>
                ...
                <div className="mt-8 rounded-xl overflow-hidden border">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3556.0!2d94.0267!3d25.6539!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3740850c0b6bb9c1%3A0x1e6b0a59ea7a1f0!2sKhonoma%2C%20Nagaland!5e0!3m2!1sen!2sin!4v1704000000000!5m2!1sen!2sin"
                    width="100%"
                    height="200"
                    style={{ border: 0 }}
                    allowFullScreen
                    ...
                    title="Khonoma, Nagaland Location"
                  ></iframe>
                </div>
              </div>
